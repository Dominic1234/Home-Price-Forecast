...
def test_server_connection():
    ...
    try:
        ...
        test_data = {"features": [3111, 2029,3,1, 2, 3, 500, 250, 25]}
...
def test_batch_prediction():
    ...
    try:
        ...
        batch_data = {
            "features": [
                [3111, 2029,1,1, 2, 3, 500, 250, 25],
                [3111, 2029,2,1, 2, 3, 500, 250, 25],
                [3111, 2029,3,1, 2, 3, 500, 250, 25],
                [3111, 2029,4,1, 2, 3, 500, 250, 25],
                [3111, 2029,5,1, 2, 3, 500, 250, 25],
                [3111, 2029,6,1, 2, 3, 500, 250, 25],
                [3111, 2029,7,1, 2, 3, 500, 250, 25],
                [3111, 2029,8,1, 2, 3, 500, 250, 25],
                [3111, 2029,9,1, 2, 3, 500, 250, 25],
                [3111, 2029,10,1, 2, 3, 500, 250, 25],
                [3111, 2029,11,1, 2, 3, 500, 250, 25],
                [3111, 2029,12,1, 2, 3, 500, 250, 25],
            ]
        }
