...
const troubleshootSections = [
    ...
    { id: 'forecast', title: 'Forecast Problems', content: 'Issues with prediction results or inputs.' },
    { id: 'api', title: 'API Errors', content: '500, 404, or connection errors with the ML model API.' }
  ];
